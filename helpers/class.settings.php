...
class WIS_SCR_Settings {
	const OPT_SETTINGS = 'wis_backup_settings';
	public static $Data;
	public static $Version = WIS_SCRAPPER_VERSION;
	/**
	...
	*/
	public static function LegacyClean() {
		global $wpdb;
		/* PRE 5.0 */
		$table = $wpdb->prefix."wis_scrapper";
	...
	*/
	public static function DeleteWPOption($optionName) {
		...
		if ( in_array($optionName, $GLOBALS['WIS_SCRAPPER_OPTS_DELETE']) ) {
	...
	public static function GetAllDefaults() {	
		...
		/* Flag used to remove the wp_options value scrapper_settings which are all the settings in this class */
